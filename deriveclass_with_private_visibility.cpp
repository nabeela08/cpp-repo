...
//default visibility mode is private so since we have not specified the mode of opening therefore it will open in private mode.
// id, salary which are the public members of employee will now become the private members of programmer.
{
public:
...
int main()
{
    ...
    programmer skillf(1);
    // cout<<skillf.id<<endl; // this will give an error because id is private member of programmer class.
